...
- **Trading Engine** -- Automated trading strategies with instruments, drivers, signal pipelines, escalation policies, and full analytics. Standalone stop-loss, take-profit, and trailing stop rules
...
| `trading-engine` | Automated trading strategies with signal pipelines, LLM decisions, and analytics. Standalone stop-loss/take-profit/trailing stop rules. |
